...
function af0_4(method_index)
{
    let checkbox = document.getElementById("af0_4");
    let status_buff = [0, 0, 0, 0, 0, 0, 0, 0]; 
    if (checkbox.checked && (char_propaty [1] == 0 ||char_propaty[1] == 1 || char_propaty[1] == 2) && method_index == 0)
    {
...
function af1_4(method_index)
{
    let checkbox = document.getElementById("af1_4");
    let status_buff = [0, 0, 0, 0, 0, 0, 0, 0]; 
    if (checkbox.checked && (char_propaty [1] == 3 || char_propaty[1] == 4) && method_index == 1)
    {
        status_buff = [0, 0, 0, 0, 0, 0, 0, 0.35]; 
    }
    return status_buff
...
function af2_2(method_index)
{
    let checkbox = document.getElementById("af2_2");
    let status_buff = [0, 0, 0, 0, 0, 0, 0, 0]; 
    if (checkbox.checked && method_index == 4)
    {
