...
async function calculate_char_base_status() 
{
  ...
  const response = await fetch("../data/character/char_data/" + CharJsonData["CharMap"][selectedCharId.toString()]["名前"] + ".json");
...
async function calculate_weapon_base_status() 
{
  ...
  const response = await fetch("../data/weapon/weapon_data/" + WeaponJsonData["CharMap"][selectedWeaponId.toString()]["名前"] + ".json");
  const data = await response.json();
...
async function calculate_depend_status()
{
  ...
  const char_response = await fetch("../data/character/char_data/" + CharJsonData["CharMap"][selectedCharId.toString()]["名前"] + ".json");
  ...
  if (attack_method != 0)
 {
  ...
  const weapon_response = await fetch("../data/weapon/weapon_data/" + WeaponJsonData["CharMap"][selectedWeaponId.toString()]["名前"] + ".json");
