async function show_artifact() 
{
    ...
    for (let i = 0; i < 2; i++)
    {
        if (SelectedAfId[i] == "0") 
        {
            ...
            if (i == 1 && SelectedAfId[0] == SelectedAfId[1])
            {
