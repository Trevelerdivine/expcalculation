    ...
    if (attack_method == 16)
    {
      if (char_constellations < 2)
      {
        traits = [
          ...
          createSelectList("kinich_skill_count2", 0, 1, "", "回", 0),
          document.createElement("br"),
          createLabel("kinich_skill_count3", "　　狩人の心得１層："),
          createSelectList("kinich_skill_count3", 0, 1, "", "回", 1),
          document.createElement("br"),
          createLabel("kinich_skill_count4", "　　狩人の心得２層："),
          createSelectList("kinich_skill_count4", 0, 1, "", "回", 0),
          document.createElement("br"),
        ];
      ...
      else
      {
        traits = [
          ...
          createSelectList("kinich_skill_count5", 0, 1, "", "回", 0),
          document.createElement("br"),
